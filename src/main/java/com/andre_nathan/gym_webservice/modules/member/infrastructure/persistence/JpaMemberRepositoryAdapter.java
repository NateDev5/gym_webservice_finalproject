...
public class JpaMemberRepositoryAdapter implements MemberRepositoryPort {
    ...
    private Member toDomain (MemberJpaEntity entity) {
        ...
        return new Member(
                ...
                com.andre_nathan.gym_webservice.modules.member.domain.model.FullName.of(entity.fullName),
                entity.dateOfBirth,
                com.andre_nathan.gym_webservice.modules.member.domain.model.EmailAddress.of(entity.email),
                com.andre_nathan.gym_webservice.modules.member.domain.model.PhoneNumber.of(entity.phone),
                new com.andre_nathan.gym_webservice.modules.member.domain.model.MembershipPlan(
                        membershipPlanEntity.planId,
                        membershipPlanEntity.planName,
                        membershipPlanEntity.durationInMonths,
                        membershipPlanEntity.price
                ),
                com.andre_nathan.gym_webservice.modules.member.domain.model.MembershipStatus.valueOf(entity.membershipStatus),
