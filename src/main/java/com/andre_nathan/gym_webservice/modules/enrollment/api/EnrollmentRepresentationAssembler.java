...
import com.andre_nathan.gym_webservice.modules.member.api.MemberController;
import com.andre_nathan.gym_webservice.modules.member.application.port.out.MemberRepositoryPort;
import com.andre_nathan.gym_webservice.modules.schedule.api.ScheduleController;
import com.andre_nathan.gym_webservice.modules.schedule.application.port.out.ScheduleRepositoryPort;
import com.andre_nathan.gym_webservice.modules.trainer.api.TrainerController;
...
public class EnrollmentRepresentationAssembler extends RepresentationModelAssemblerSupport<Enrollment, EnrollmentResponse> {
    ...
    private EnrollmentResponse.EnrollmentItemResponse toItemResponse(EnrollmentItem item) {
        ...
        var trainer = trainerRepository.findById(com.andre_nathan.gym_webservice.modules.trainer.domain.model.TrainerId.of(item.getTrainerId())).orElse(null);
